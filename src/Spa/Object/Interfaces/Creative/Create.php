    ...
    protected function fieldInfo() {
        ...
        array(
            ...
            'creative_template_id' => array(
                ...
                'require' => 'yes',
                'type' => 'integer','description' => '素材规格Id',
            ...
            'destination_url' => array(
                ...
                'require' => 'yes',
                'type' => 'string','description' => '素材目标url',
            ...
            'impression_tracking_url' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '曝光监控地址',
                'restraint' => '小于1023个英文字符',
                'errormsg' => '曝光监控地址不正确',
                'max_length' => '1023',
                'min_length' => '0',
            ...
            'dynamic_creative_template_id' => array(
                ...
                'require' => 'no',
                'type' => 'id','description' => '动态创意模板ID（仅动态创意特性允许使用）',
                'restraint' => '小于2^63',
            ...
            'dynamic_creative_material_label' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '动态创意模板物料标签（仅动态创意特性允许使用）',
