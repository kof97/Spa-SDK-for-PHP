    ...
    protected function fieldInfo() {
        ...
        array(
            ...
            'bid_type' => array(
                ...
                'extendType' => 'bid_type',
                'require' => 'yes',
                'type' => 'string','description' => '扣费方式，如CPD、CPM',
            ...
            'bid_amount' => array(
                ...
                'require' => 'yes',
                'type' => 'integer','description' => '广告出价，单位为分',
                'restraint' => '广告出价，单位为分',
                'errormsg' => '广告出价不正确',
                );
            ...
            'time_series' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '投放时间段，格式为48 * 7位由0和1组成的字符串，也就是以半个小时为最小粒度，0为不投放，1为投放',
            ...
            'subordinate_product_refs_id' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '子标的物id（渠道包id）',
            ...
            'creative_selection_type' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '素材播放模式',
            ...
            'customized_category' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '自定义分类，关键词分割，如，本地生活——餐饮',
            ...
            'min_impression_include' => array(
                ...
                'require' => 'no',
                'type' => 'integer','description' => '最低曝光频次',
            ...
            'max_impression_include' => array(
                ...
                'require' => 'no',
                'type' => 'integer','description' => '最高曝光频次',
                'restraint' => '大于等于0、小于等于1000',
                'errormsg' => '最高曝光频次不正确',
                );
            ...
            'creative_combination_type' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '广告类型，支持普通广告、集装箱广告和动态创意广告',
            ...
            'dynamic_creative_recommend_type' => array(
                ...
                'require' => 'no',
                'type' => 'integer','description' => '产品推荐方式',
