    ...
    protected function fieldInfo() {
        ...
        array(
            ...
            'audience_type' => array(
                ...
                'require' => 'yes',
                'type' => 'string','description' => '人群类型，如：Meta、Combine、Lookalike',
            ...
            'refs_app_id' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => 'OpenId对应的AppId',
                'restraint' => '1-128个字符',
                'errormsg' => 'AppId不正确',
                'max_length' => '128',
                'min_length' => '1',
            ...
            'outer_audience_id' => array(
                ...
                'require' => 'no',
                'type' => 'integer','description' => '外部人群规则Id',
                'restraint' => '小于2^63',
