    ...
    protected function fieldInfo() {
        ...
        array(
            ...
            'certification_image_id' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '营业执照/企业资质证明图片id',
                'restraint' => '小于32个英文字符',
            ...
            'industry_id' => array(
                ...
                'require' => 'no',
                'type' => 'integer','description' => '最细一级行业分类（最细有3级）',
            ...
            'qualification_image_id_list' => array(
                ...
                'require' => 'no',
                'type' => 'array','description' => '广告特殊资质证明图片ID。最多不超过1
0个',
            ...
            'website' => array(
                ...
                'extendType' => 'website',
                'require' => 'no',
                'type' => 'string','description' => '推广站点地址',
                'restraint' => 'URL小于255个英文字符',
                'errormsg' => '推广站点地址不正确',
                'max_length' => '255',
                'min_length' => '1',
            ...
            'contact_person_email' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '联系人email',
            ...
            'contact_person_mobile' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '联系人手机号码',
            ...
            'contact_person_telephone' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '联系人座机电话号码',
            ...
            'contact_person_qq' => array(
                ...
                'require' => 'no',
                'type' => 'integer','description' => '联系人QQ',
                'restraint' => '小于42亿',
                'errormsg' => '联系人QQ不正确',
                );
            ...
            'corporate_reg_no' => array(
                ...
                'require' => 'no',
                'type' => 'string','description' => '企业营业执照注册号',
